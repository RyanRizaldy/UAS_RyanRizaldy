...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Aboutimg.jpg"))); // NOI18N
        ...
        email_input.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel6.setFont(new java.awt.Font("Yu Gothic UI Light", 1, 14)); // NOI18N
        jLabel6.setText("Password");

        password_input.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(password_input, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE))
    ...
    private void login_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_buttonActionPerformed
        if(email_input.getText().equals("") && password_input.getText().equals("")){
...
java.sql.ResultSet sql = stm.executeQuery("select * from users where email='" + email_input.getText() + "' and password = '" + password_input.getText() + "'");
if (sql.next()) {
if (password_input.getText().equals(sql.getString("password"))) {
